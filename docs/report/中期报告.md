...
| 导出模块 | `main.py - export_csv()` | 导出图书列表为 CSV 文件 |
| 前端交互 | `index.html` | 页面展示、表单提交、AJAX 请求、批量操作 |
...
| 测试类型 | 测试范围 | 测试方法 |
|----------|----------|----------|
| 功能测试 | 增删改查、批量删除、搜索、统计、导出 | 手动执行测试用例 |
...
- ✅ 完成 Flask 后端 API 开发（增删改查、批量删除、搜索、统计、导出）
- ✅ 完成前端页面开发（列表展示、弹窗表单、统计看板、批量操作）
- ✅ 实现首次运行自动建表，简化部署流程
- ✅ 系统可正常运行，核心功能完整
